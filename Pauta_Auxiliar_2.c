...
int main() {
	...
	printf("posicionBits(0x01010101, 01, 8) == %d\n", posicionBits(0x01010101, 01, 8));
	printf("repBitsClase(0x01010101, 0, 2, 01) == 0x%X\n", repBitsClase(0x01010101, 1, 1, 1));
	printf("repBitsOriginal(0x5555FFFF, 8, 12, 0x123) == 0x%X\n", repBitsOriginal(0x01010101, 1, 2, 2));
	return 0;
}
